...
public class ProfessorJAVAController implements Initializable
{
    @FXML
    ...
    public void studentShowData()
    {
        ...
        crud_col_Score.setCellValueFactory(new PropertyValueFactory<>("scoreJAVA"));
    ...
    public void switchGroup(ActionEvent event) throws SQLException
    {
        ...
        {
            String checkDataA = "SELECT professor_id FROM professor_info WHERE groupee='A' AND module='JAVA'";
        ...
        {
            String checkDataB = "SELECT professor_id FROM professor_info WHERE groupee='B' AND module='JAVA'";
        ...
        {
            String checkDataD = "SELECT professor_id FROM professor_info WHERE groupee='D' AND module='JAVA'";
        ...
        {
            String checkDataC = "SELECT professor_id FROM professor_info WHERE groupee='C' AND module='JAVA'";
    ...
    public ObservableList<studentData> studentListAData()
    {
        ...
        try
        {
            ...
            while(result.next())
            {
                    v=(result.getInt("S1JAVA")+result.getInt("S2JAVA")+
                        result.getInt("S3JAVA")+result.getInt("S4JAVA")+
                        result.getInt("S5JAVA")+result.getInt("S6JAVA")+
                        result.getInt("S7JAVA")+result.getInt("S8JAVA"))*100;
    ...
    public void studentShowA()
    {
        ...
        col_S1.setCellValueFactory(new PropertyValueFactory<>("S1JAVA"));
        col_S2.setCellValueFactory(new PropertyValueFactory<>("S2JAVA"));
        col_S3.setCellValueFactory(new PropertyValueFactory<>("S3JAVA"));
        col_S4.setCellValueFactory(new PropertyValueFactory<>("S4JAVA"));
        col_S5.setCellValueFactory(new PropertyValueFactory<>("S5JAVA"));
        col_S6.setCellValueFactory(new PropertyValueFactory<>("S6JAVA"));
        col_S7.setCellValueFactory(new PropertyValueFactory<>("S7JAVA"));
        col_S8.setCellValueFactory(new PropertyValueFactory<>("S8JAVA"));
        col_Percent.setCellValueFactory(new PropertyValueFactory<>("percentJAVA"));
    ...
    public void studentShowB()
    {
        ...
        col_S11.setCellValueFactory(new PropertyValueFactory<>("S1JAVA"));
        col_S21.setCellValueFactory(new PropertyValueFactory<>("S2JAVA"));
        col_S31.setCellValueFactory(new PropertyValueFactory<>("S3JAVA"));
        col_S41.setCellValueFactory(new PropertyValueFactory<>("S4JAVA"));
        col_S51.setCellValueFactory(new PropertyValueFactory<>("S5JAVA"));
        col_S61.setCellValueFactory(new PropertyValueFactory<>("S6JAVA"));
        col_S71.setCellValueFactory(new PropertyValueFactory<>("S7JAVA"));
        col_S81.setCellValueFactory(new PropertyValueFactory<>("S8JAVA"));
        col_Percent1.setCellValueFactory(new PropertyValueFactory<>("percentJAVA"));
    ...
    public void studentShowC()
    {
        ...
        col_S111.setCellValueFactory(new PropertyValueFactory<>("S1JAVA"));
        col_S211.setCellValueFactory(new PropertyValueFactory<>("S2JAVA"));
        col_S311.setCellValueFactory(new PropertyValueFactory<>("S3JAVA"));
        col_S411.setCellValueFactory(new PropertyValueFactory<>("S4JAVA"));
        col_S511.setCellValueFactory(new PropertyValueFactory<>("S5JAVA"));
        col_S611.setCellValueFactory(new PropertyValueFactory<>("S6JAVA"));
        col_S711.setCellValueFactory(new PropertyValueFactory<>("S7JAVA"));
        col_S811.setCellValueFactory(new PropertyValueFactory<>("S8JAVA"));
        col_Percent11.setCellValueFactory(new PropertyValueFactory<>("percentJAVA"));
    ...
    public void studentShowD()
    {
        ...
        col_S1111.setCellValueFactory(new PropertyValueFactory<>("S1JAVA"));
        col_S2111.setCellValueFactory(new PropertyValueFactory<>("S2JAVA"));
        col_S3111.setCellValueFactory(new PropertyValueFactory<>("S3JAVA"));
        col_S4111.setCellValueFactory(new PropertyValueFactory<>("S4JAVA"));
        col_S5111.setCellValueFactory(new PropertyValueFactory<>("S5JAVA"));
        col_S6111.setCellValueFactory(new PropertyValueFactory<>("S6JAVA"));
        col_S7111.setCellValueFactory(new PropertyValueFactory<>("S7JAVA"));
        col_S8111.setCellValueFactory(new PropertyValueFactory<>("S8JAVA"));
        col_Percent111.setCellValueFactory(new PropertyValueFactory<>("percentJAVA"));
    ...
    public void SelectDataA()
    {
        ...
        crud_S1.setText(String.valueOf(sData.getS1JAVA()));
        crud_S2.setText(String.valueOf(sData.getS2JAVA()));
        crud_S3.setText(String.valueOf(sData.getS3JAVA()));
        crud_S4.setText(String.valueOf(sData.getS4JAVA()));
        crud_S5.setText(String.valueOf(sData.getS5JAVA()));
        crud_S6.setText(String.valueOf(sData.getS6JAVA()));
        crud_S7.setText(String.valueOf(sData.getS7JAVA()));
        crud_S8.setText(String.valueOf(sData.getS8JAVA()));
    }
        ...
        try 
        {
            ...
            }else
            {
                ...
                updateData = "UPDATE student_info SET "
                        + "S1JAVA = '" + crud_S1.getText()
                        + "', S2JAVA = '" + crud_S2.getText()
                        + "', S3JAVA = '" + crud_S3.getText()
                        + "', S4JAVA = '" + crud_S4.getText()
                        + "', S5JAVA = '" + crud_S5.getText()
                        + "', S6JAVA = '" + crud_S6.getText()
                        + "', S7JAVA = '" + crud_S7.getText()
                        + "', S8JAVA = '" + crud_S8.getText()
    ...
    public void SelectDataa()
    {
        ...
        crud_score.setText(String.valueOf(Dataaa.getScoreJAVA()));
    }
